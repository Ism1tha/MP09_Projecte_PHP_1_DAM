...
function greeting() {
    ...
    return '<div class="flex items-center bg-green-500 text-white text-sm font-bold px-4 py-3 mb-8 rounded-md" role="alert">
    ...
    <p>Hola, ' . $sanitized_full_name . '. Estàs veient la pàgina realitzada per Ismael Semmar durant el curs de Laravel d\'Acacha (INSEBRE)</p></div>';
}